                    ...
                    <tbody>
                        {/* row 1 */}
                        {
                            data?.map((data, index) => <tr key={data._id}>
                                ...
                                <td>{data?.name}</td>
                                <td>{data?.email}</td>
                                <td>{data?.role !== "admin" && <button onClick={() => handelMakeadmin(data?._id)} className="btn btn-success">Make admin</button>}</td>
                                <td><button onClick={() => handelDelete(data?._id)} className="btn btn-outline btn-denger">Delete</button></td>
